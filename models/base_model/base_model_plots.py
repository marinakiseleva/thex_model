...
class BaseModelVisualization:
    ...
    def plot_probability_correctness(self, prob_ranges=None):
        """
        Plots accuracy (y) vs. probability assigned to class (x)
        :param prob_ranges: Can manually pass in mapping otherwise generated by get_corr_prob_ranges; useful when this is pre-computed as an average over multiple folds/runs
        """
        ...
        for index, class_code in enumerate(self.get_unique_classes()):
            ...
            plot_title = avg_title + 'Accuracy of ' + \
                code_cat[class_code] + ' Predictions by Probability Assigned'
